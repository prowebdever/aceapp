...
{
    public class SubrogationClaimDto
    {
        // Company part
        // Company part
        ...
        public string ContactAdverseLastNameOrBusinessName { get; set; }
        public string ContactAdverseFirstName { get; set; }
        [Required(ErrorMessage = "Phone number is required.")]
        [RegularExpression(@"^\d{3}?[\s.-]\d{3}[\s.-]\d{4}$", ErrorMessage = "Phone number should be like 123-345-6789")]
        public string ContactPhoneNumber { get; set; }
        public int LiabilityPercent { get; set; }
