...
{
    public partial class SubrogationModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "SubrogationClaims",
                columns: table => new
                {
                    ...
                    ContactAdverseLastNameOrBusinessName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ContactAdverseFirstName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ContactPhoneNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    LiabilityPercent = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubrogationClaims", x => x.ID);
                    table.ForeignKey(
                        name: "FK_SubrogationClaim_AspNetUsers",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubrogationClaims_UserId",
                table: "SubrogationClaims",
                column: "UserId");
        }
