...
{
    public partial class AddSpecialtyClaim : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "SpecialtyClaims",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialtyClaims", x => x.ID);
                    table.ForeignKey(
                        name: "FK_SpecialtyClaim_AspNetUsers",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialtyClaims_UserId",
                table: "SpecialtyClaims",
                column: "UserId");
        }
